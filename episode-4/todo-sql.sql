...
if (db_id('dab-youtube-ep-4') is not null) begin
    alter database [dab-youtube-ep-4] set single_user with rollback immediate;
    drop database [dab-youtube-ep-4];
end
go

create database [dab-youtube-ep-4];
go
use [dab-youtube-ep-4]
go
