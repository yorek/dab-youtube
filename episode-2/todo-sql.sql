...
if (db_id('dab-youtube-ep-2') is not null) begin
    alter database [dab-youtube-ep-2] set single_user with rollback immediate;
    drop database [dab-youtube-ep-2];
end
go

create database [dab-youtube-ep-2];
go
use [dab-youtube-ep-2]
go
