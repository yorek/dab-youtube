...
if (db_id('dab-youtube-ep-1') is not null) begin
    alter database [dab-youtube-ep-1] set single_user with rollback immediate;
    drop database [dab-youtube-ep-1];
end
go

create database [dab-youtube-ep-1];
go
use [dab-youtube-ep-1]
go
